...
public class Blur {
    public static Bitmap bkg;    //保存 壁纸高斯模糊后的图片
    ...
    //fromview为背景布局，由此布局提取处需要模糊的背景. toview为需要加载模糊后背景的图层，scaleFactor和roundCorner为模糊参数
...
//        Paint paint = new Paint();
//        paint.setFlags(Paint.FILTER_BITMAP_FLAG);
//        canvas.drawBitmap(bkg_origin, 0, 0, paint);
       // overlay = doBlur(overlay, radius, true);
      //  bkg=Bitmap.createScaledBitmap(overlay,width,height, true);
